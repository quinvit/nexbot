...
process.env.HUBOT_REDMINE_SSL = true
process.env.HUBOT_REDMINE_BASE_URL = "https://redmine.nexcel.vn"
process.env.HUBOT_REDMINE_TOKEN = "245d599e09b553a4661515bce90e6b48e408d56d"
